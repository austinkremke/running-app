...
**Product priority (next feature):** [05 Phase 2 — Elo & rank UI](./05-matchmaking-and-feed.md#phase-2--elo--rank-ui-next) or [02 Phase E — hardening](./02-supabase-backend.md).
...
| 05 | [Matchmaking, feed & social sync](./05-matchmaking-and-feed.md) | **In progress** — Phase 1 likes & comments shipped | 02 (Phase C+) | — |
