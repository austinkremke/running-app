...
| 04 | [Third-party integrations](./04-third-party-integrations.md) | Planned — **Garmin approach superseded by [09](./09-wearable-integration.md)**; Strava import still valid | 01, 02 | 05 |
...
| 09 | [Wearable integration (HealthKit)](./09-wearable-integration.md) | Planned | 01, 02, 03 | Heart Rate Analysis (currently dead), Garmin without partner approval |
...
07 Team play — creation · management · team matchmaking (mirrors 05 solo patterns)
        │
        ▼
08 Run detail — fullscreen map · charts · mile splits · delete (opens from feed / anywhere)
```
