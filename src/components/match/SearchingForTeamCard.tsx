...
type SearchingForTeamCardProps = {
  onCancel: () => void;
};

export function SearchingForTeamCard({ onCancel }: SearchingForTeamCardProps) {
      ...
      <View style={styles.card}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.meta}>
            <Text style={styles.title}>Searching for an Opponent Team</Text>
            <Text style={styles.subtitle}>Looking for a team of similar skill</Text>
