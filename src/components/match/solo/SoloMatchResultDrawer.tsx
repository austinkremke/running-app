...
import { formatMatchPoints } from './soloMatchTheme';
...
function outcomeCopy(outcome: SoloMatchCompletion['outcome']) {
  ...
  return {
    title: 'Match Tied',
    subtitle: 'Even duel — no rating change',
...
export function SoloMatchResultDrawer({ visible, completion, onClose }: SoloMatchResultDrawerProps) {
      ...
      <View style={styles.content}>
        ...
        <View style={styles.scoreCard}>
          ...
          <Text style={styles.scoreLine}>
            You {formatMatchPoints(completion.myPoints)} — {formatMatchPoints(completion.opponentPoints)}{' '}
            {completion.opponentName}
          </Text>
        </View>
        ...
        <View style={styles.statsRow}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statMeta}>{completion.newRating.toLocaleString()} PR</Text>
          </View>
