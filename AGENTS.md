...
- **Milestone 07 (next):** team play — creation/management, team Elo (`team_rank`), team matchmaking with top-N contributor scoring. See [milestones/07-team-play.md](milestones/07-team-play.md).
